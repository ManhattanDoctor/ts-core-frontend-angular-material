...
import { ViewUtil, IWindowConfig, WindowAlign } from '@ts-core/angular';

export class WindowConfig<T = any> extends MatDialogConfig<T> implements MatBottomSheetConfig<T>, IWindowConfig<T>, IDestroyable {
    // --------------------------------------------------------------------------
    //
    // 	Properties
    //
